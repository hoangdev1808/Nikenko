										...
										<asp:ChangePassword ID="ChangePassword1" Width="100%" runat="server">
											<ChangePasswordTemplate>
												<div class="account-form clearfix">
													<asp:Panel ID="divCurrentPassword" runat="server"
														class="form-group">
														...
														<asp:RequiredFieldValidator ControlToValidate="CurrentPassword"
															ID="CurrentPasswordRequired" Display="Dynamic"
															runat="server" ValidationGroup="ChangePassword1" />
													</asp:Panel>
													<div class="form-group clearfix">
														<gb:SiteLabel ID="lblNewPassword" runat="server"
															ForControl="NewPassword"
															ConfigKey="ChangePasswordNewPasswordLabel" />
														<telerik:RadTextBox runat="server" ID="NewPassword"
														...
														<asp:RegularExpressionValidator ID="NewPasswordRegex"
															runat="server" ControlToValidate="NewPassword"
															Display="Dynamic" ValidationGroup="ChangePassword1" />
														<asp:CustomValidator ID="NewPasswordRulesValidator"
															runat="server" ControlToValidate="NewPassword"
															Display="Dynamic" ValidationGroup="ChangePassword1" />
													</div>
													<div class="form-group clearfix">
														...
														<asp:CompareValidator ControlToCompare="NewPassword"
															ControlToValidate="ConfirmNewPassword"
															ID="NewPasswordCompare" runat="server" Display="Dynamic"
															ValidationGroup="ChangePassword1" />
													</div>
													<div class="form-group clearfix">
													...
													<asp:Button SkinID="DefaultButton" ID="ChangePasswordPushButton"
														...
														runat="server" ValidationGroup="ChangePassword1" />
													<asp:Button SkinID="DefaultButton" ID="CancelPushButton"
