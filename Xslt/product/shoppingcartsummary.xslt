<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" version="1.0" exclude-result-prefixes="msxsl">
    ...
    <xsl:template match="/ShoppingCart">
        ...
        <section class="minicart clearfix">
            <div class="carttitle">
                <p>
                    <xsl:value-of select="CartText" disable-output-escaping="yes"></xsl:value-of>
            ...
            <div class="carttable clearfix">
                ...
                <div class="group">
                    <div class="label">
                        <xsl:value-of select="PVCext" disable-output-escaping="yes"></xsl:value-of>
                ...
                <div class="group">
                    <div class="label">
                        <xsl:value-of select="TTText" disable-output-escaping="yes"></xsl:value-of>
                    </div>
        ...
        <div class="admin-wrap checkout-discount">
            <div class="admin-title">
                <div class="text">
                    <xsl:value-of select="GiftText" disable-output-escaping="yes"></xsl:value-of>
                </div>
            </div>
            <div class="carttable">
                <div class="normal-text">
                    <xsl:value-of select="EnterCodeText" disable-output-escaping="yes"></xsl:value-of>
                </div>
                <div class="wrapper-form">
                        ...
                        <div class="setting-control">
                            <xsl:choose>
                                ...
                                <xsl:otherwise>
                                    ...
                                    <button onclick="AjaxCart.applycoupon();return false;">
                    ...
                    <div class="check-text">
                        <xsl:value-of select="MinutesText" disable-output-escaping="yes"></xsl:value-of>
                    </div>
                    <div class="normal-text">
                        <xsl:value-of select="DuringText" disable-output-escaping="yes"></xsl:value-of>
                    </div>
                </div>
            </div>
        </div>
